...
export default function TermsView() {
  ...
  const NAME = "Founder Finance";
  const DOMAIN = process.env.NEXT_PUBLIC_BASE_URL ?? "";
  const PRIVACY_URL = `${DOMAIN}/privacy`;
  const CONTACT_EMAIL = "sujalgundalbusiness@gmail.com";

  return (
    <Layout>
      <PageHead title="Terms of Service | Founder Finance" />
